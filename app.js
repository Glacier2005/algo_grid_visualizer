...
const clearPath = () => {
    clearAllTimers(); // FIX: Clear all running animations
    cells.forEach(cell => {
...
const clearBoard = () => {
    clearPath(); // Utilizing clearPath since it clears animations now
    cells.forEach(cell => {
...
GenerateMazebtn.addEventListener('click', () => {
    walltoanimate = [];
    clearBoard(); // Clear board before generating new maze
